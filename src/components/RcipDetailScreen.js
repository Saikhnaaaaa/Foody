...
import CachedImage from '../contents/helpers/CachedImage'
...
export default function RcipDetailScreen(props) {
    ...
    const getMealData = async (id)=>{
        try {
            ...
            // console.log('getting meal id', response.data)
    ...
    <ScrollView
        ...
        >
            ...
            <View className="w-full absolute flex-row justify-between items-center pt-14">
                ...
                <TouchableOpacity onPress={()=> setisFavorite(!isFav)} className="p-2 rounded-full mr-5 bg-white">
